...
def sepcnn_model(blocks,
    ...
    # Arguments
        ...
        dropout_rate: float, percentage of input to drop at Dropout layers.
        pool_size: int, factor by which to downscale input at MaxPooling layer. size of the max pooling windows.
        input_shape: tuple, shape of input to the model.
        num_classes: int, number of output classes.
    ...
    if use_pretrained_embedding:
        model.add(tf.keras.layers.Embedding(input_dim=num_features,
    ...
    model.add(tf.keras.layers.Dropout(rate=dropout_rate))
    model.add(tf.keras.layers.Dense(op_units, activation=op_activation))
    return model
